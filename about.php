        ...
        <div class="w3ls-section w3_agileits-about" id="services">
            ...
            <div class="main-about-w3ls">
                <div class="col-md-8 col-sm-8 col-xs-8 agileinfo-about abt-rad">
                    <h4 class="info">1 . Explain your health concern .</h4>
                </div>
                ...
                <div class="col-md-8 col-sm-8 col-xs-8 agileinfo-about">
                  <h4 class="info">2 . Get quick medical advice .</h4>
                </div>
                <div class="clearfix"></div>
				<!--team --><br>
<div class="team agileits-w3layouts" id="team">
	<h4 class="w3ls-inner-title">     Mediconnect Team</h4>
		<div class="team-w3ls">
			<div class="col-md-6 col-sm-6 col-xs-6 team-grid w3_agileits">
				<img class="col-md-3 img-w3l t1-wthree img-responsive" src="images/kn.jpg" alt="">
				<div class="col-md-9 team-w3ls-txt">
					<h5>Karthik Nair</h5>
					<p>Computer Engineer , D.J. Sanghvi College</p>
					<ul class="agileits_social_icons">
						<li><a href="https://www.facebook.com/kartik.nair.161" class="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
			...
			<div class="col-md-6  col-sm-6 col-xs-6 team-grid w3_agileits">
				<img class="col-md-3 img-w3l t1-wthree img-responsive" src="images/hp.jpg" alt="">
				<div class="col-md-9 team-w3ls-txt">
					<h5>Harsh Parekh</h5>
					<p>Computer Engineer , D.J. Sanghvi College</p>
					<ul class="agileits_social_icons">
						<li><a href="https://www.facebook.com/harsh.parekh.731"
			...
			<div class="col-md-6  col-sm-6 col-xs-6 team-grid w3_agileits t2">
				<img class="col-md-3 img-w3l t1-wthree img-responsive" src="images/pp.jpg" alt="">
				<div class="col-md-9 team-w3ls-txt">
					<h5>Purvam Pujari</h5>
					<p>Computer Engineer , D.J. Sanghvi College</p>
					<ul class="agileits_social_icons">
						<li><a href="https://www.facebook.com/purvam.pujari" class="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
						<li><a href="#" class="twitter"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
						<li><a href="#" class="google"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
					</ul>
				</div>	
											...
											<form action="signup.php" method="post">
												...
												<div class="signin-rit">
													<span class="agree-checkbox">
														<label class="checkbox"><input type="checkbox" name="checkbox">I agree to your <a class="w3layouts-t"  href="terms.php" target="_blank">Terms of Use</a> and <a class="w3layouts-t" href="privacy.php" target="_blank">Privacy Policy</a></label>
													</span>
												</div>
												<div class="tp">
