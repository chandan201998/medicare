												...
												<?php
																...
																while($row_posts=mysqli_fetch_array($run_posts)){
																	...
																	<a id='profile' href='profile.php?id=$id'> <img src='images/$u_image' width='4%' height='4%'  style='border-radius:'60%'></a>
																	 <a class='profilep' href='profile.php?id=$id'><h3 style='color:#018E3F'>$name</h3></a>
																	</div>
...
echo $_SESSION['email'] ; ?></span></a>
		...
		<li id="menu-academico" ><a href="#"><i class="fa fa-table"></i> <span>Funding</span> <span class="fa fa-angle-right" style="float: right"></span></a>
										   <ul id="menu-academico-sub" >
											<li id="menu-academico-avaliacoes" ><a href="raise_fund.php"> Raise Funding </a></li>
											<li id="menu-academico-avaliacoes" ><a href="more_fund_info.php"> More Info </a></li>
										  </ul>
										</li>
		<li><a href="editor.php"><i class="lnr lnr-pencil"></i> <span>Request Doc </span></a></li>
